---
title: "Contributor Spotlight: Ankit Kurmi"
date: 2026-04-21T06:00:00
draft: false
image:
    url: ankit-github.png
    attribution:
authors:
  - spron-in
tags:
  ...
  - kubernetes
  - databases
summary: "Meet Ankit Kurmi — Site Reliability Engineer at Red Hat, a collector of hobbies, and a new voice in the OpenEverest community."
---
...
Want to connect with Ankit? You can find him on [GitHub](https://github.com/Ankit152) and [LinkedIn](https://www.linkedin.com/in/ankitk152/). To get involved with OpenEverest yourself, join us on the [CNCF Slack](https://cloud-native.slack.com/archives/C09RRGZL2UX) in the `#openeverest-users` channel, or explore the project on [GitHub](https://github.com/openeverest/openeverest).
